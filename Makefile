...
sales_force_start:
	@docker pull repo.rmgops.com/docker/upload_pdf/salesforce_uploader:develop && \
	docker run -it -d -p 9065:9065 --name salesforce_uploader --mount source=myvolume,target=/ipg -v /archived:/archived repo.rmgops.com/docker/upload_pdf/salesforce_uploader:develop
...
sales_force_prod_start:
	...
	docker run -it -d -p 9065:9065 --name salesforce_uploader --mount source=myvolume,target=/ipg -v /archived:/archived repo.rmgops.com/docker/upload_pdf/salesforce_uploader:master
